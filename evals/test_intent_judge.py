...
INTENT_JUDGE_TEST_CASES = [
    ...
    IntentJudgeTestCase(
        ...
        transcript="Silas what time is it",
        last_tts_text="",
        in_hot_window=False,
        wake_timestamp=1000.5,
        expected_directed=True,
        expected_query_contains="time",
        expected_query_not_contains="silas",
    ),
    # Wake word at sentence end, adjacent to a named entity. Regression guard:
    # the judge previously left "Silas" in the query, causing the reply engine
    # to treat "Possessor Silas" as the film title instead of "Possessor".
    IntentJudgeTestCase(
        name="wake_word_trailing_after_named_entity",
        transcript="what do you know about the movie called Possessor Silas",
        last_tts_text="",
        in_hot_window=False,
    ...
    IntentJudgeTestCase(
        ...
        transcript="hey Silas what's the weather in London",
        last_tts_text="",
        in_hot_window=False,
    ...
    IntentJudgeTestCase(
        ...
        transcript="Silas set a timer for 5 minutes",
        last_tts_text="",
        in_hot_window=False,
        wake_timestamp=1000.5,
        expected_directed=True,
    ...
    IntentJudgeTestCase(
        ...
        transcript="Silas remind me to call mum at 5pm",
        last_tts_text="",
        in_hot_window=False,
        wake_timestamp=1000.5,
        expected_directed=True,
    ...
    IntentJudgeTestCase(
        ...
        transcript="Silas, I just ate a burger from McDonald's.",
        last_tts_text="",
        in_hot_window=False,
        wake_timestamp=1000.5,
        expected_directed=True,
    ...
    IntentJudgeTestCase(
        ...
        transcript="Silas I'm feeling a bit tired today",
        last_tts_text="",
        in_hot_window=False,
        wake_timestamp=1000.5,
        expected_directed=True,
    ...
    IntentJudgeTestCase(
        ...
        transcript="My flight just got cancelled, Silas",
        last_tts_text="",
        in_hot_window=False,
        wake_timestamp=1001.5,
        expected_directed=True,
    ...
    # capitalised brand/product name immediately before "Silas". Regression:
    # gemma4:e2b misread "big Mac Silas" as the compound name "Mac Silas",
    # treating "Silas" as a surname rather than the wake word, and returned
    # directed=false despite its own reasoning stating it found the wake word.
    IntentJudgeTestCase(
        name="wake_word_trailing_after_capitalised_brand",
        transcript="I just ate a big Mac Silas",
        last_tts_text="",
        in_hot_window=False,
        wake_timestamp=1001.5,
        expected_directed=True,
    ...
    # extractable query" on "Silas say something please" because it conflated
    # the open subject with a topic-less question.
    IntentJudgeTestCase(
        name="wake_word_open_imperative_say_something",
        transcript="Silas say something please",
        last_tts_text="",
        in_hot_window=False,
        wake_timestamp=1000.5,
        expected_directed=True,
    ...
    IntentJudgeTestCase(
        ...
        transcript="Silas tell me a joke",
        last_tts_text="",
        in_hot_window=False,
        wake_timestamp=1000.5,
        expected_directed=True,
    ...
    IntentJudgeTestCase(
        ...
        transcript="Silas tell me anything",
        last_tts_text="",
        in_hot_window=False,
        wake_timestamp=1000.5,
        expected_directed=True,
    ...
    IntentJudgeTestCase(
        ...
        transcript="Silas give me advice please",
        last_tts_text="",
        in_hot_window=False,
        wake_timestamp=1000.5,
        expected_directed=True,
    ...
    IntentJudgeTestCase(
        ...
        transcript="I think the weather is great today in London. What do you think, Silas?",
        last_tts_text="",
        in_hot_window=False,
    ...
    IntentJudgeTestCase(
        ...
        transcript="I told my friend about Silas yesterday",
        last_tts_text="",
        in_hot_window=False,
        wake_timestamp=1000.8,
        expected_directed=False,
...
MULTI_SEGMENT_TEST_CASES = [
    ...
    MultiSegmentTestCase(
        ...
        segments=[
            ...
            ("Silas, what about new movies tomorrow?", False),
        ],
    ...
    MultiSegmentTestCase(
        ...
        segments=[
            ...
            ("The food here is excellent. Silas, what's the best dish to order?", False),
        ],
        last_tts_text="",
        in_hot_window=False,
    ...
    MultiSegmentTestCase(
        ...
        segments=[
            ...
            ("Silas how much does that cost", False),
        ],
        last_tts_text="",
        in_hot_window=False,
        wake_timestamp=1004.0,
    ...
    MultiSegmentTestCase(
        ...
        segments=[
            ...
            ("What do you think about that Silas", False),
        ],
        last_tts_text="",
        in_hot_window=False,
    ...
    MultiSegmentTestCase(
        ...
        segments=[
            ...
            ("Silas go ahead and answer", False),
        ],
        last_tts_text="",
        in_hot_window=False,
        wake_timestamp=1002.5,
    ...
    MultiSegmentTestCase(
        ...
        segments=[
            ...
            ("Silas, answer that — actually, what time is it?", False),
        ],
        last_tts_text="",
        in_hot_window=False,
        wake_timestamp=1002.5,
    ...
    MultiSegmentTestCase(
        ...
        segments=[
            ...
            ("Silas how much does it cost", False),
        ],
        last_tts_text="",
        in_hot_window=False,
    ...
    MultiSegmentTestCase(
        ...
        segments=[
            ...
            ("Silas how much do they cost", False),
        ],
        last_tts_text="",
        in_hot_window=False,
    ...
    # turned to the assistant with "Silas, do you know what she's talking about,
    ...
    MultiSegmentTestCase(
        ...
        segments=[
            ...
            ("Silas, do you know what she's talking about, about Mata Hari?", False),
        ],
        last_tts_text="",
        in_hot_window=False,
        wake_timestamp=1004.5,
...
def create_transcript_segment(
    ...
    from silas.listening.transcript_buffer import TranscriptSegment
...
class TestIntentJudgePromptQuality:
    ...
    def test_hot_window_mode_indicated_in_prompt(self):
        from silas.listening.intent_judge import IntentJudge
    ...
    def test_processed_segment_not_reextracted(self):
        ...
        segments = [
            create_transcript_segment(
                text="Silas what's the weather in London",
                start_time=1000.0,
                processed=True,
            ),
            create_transcript_segment(
                text="Silas tell me a random topic",
                start_time=1010.0,
                processed=False,
            ),
        ]
        ...
        result = judge.judge(
            ...
            in_hot_window=False,
            current_text="Silas tell me a random topic",
        )
