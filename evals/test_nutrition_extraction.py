...
def call_nutrition_extraction(
    ...
    """
    from silas.tools.builtin.nutrition.log_meal import NUTRITION_SYS
...
class TestNutritionToolIntegration:
    ...
    def test_log_meal_tool_extracts_macros(self, mock_config, eval_db):
        ...
        """
        from silas.tools.builtin.nutrition.log_meal import LogMealTool
        from silas.tools.base import ToolContext
