...
from silas.tools.builtin.web_search import WebSearchTool
...
class TestFallbackChainRescuesBotChallenge:
    ...
    @patch("silas.tools.builtin.web_search._wikipedia_summary")
    @patch("silas.tools.builtin.web_search.requests.get")
