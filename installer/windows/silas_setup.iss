; Silas Inno Setup Script
; Builds a Windows installer from the PyInstaller onedir output.
;
; Usage:
;   iscc installer\windows\silas_setup.iss
;
; Expects the PyInstaller onedir output at dist\Silas\

#define MyAppName "Silas"
#define MyAppExeName "Silas.exe"
...
OutputDir=..\..\dist
OutputBaseFilename=Silas-Setup-x64
Compression=lzma2
...
Source: "..\..\dist\Silas\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
begin
  ...
  begin
    ...
    MsgBox(
      'GPU library download did not complete. Silas will run on CPU.' #13#10 #13#10 +
