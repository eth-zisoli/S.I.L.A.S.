...
class TestDiaryRedaction:
    ...
    @patch('src.silas.memory.conversation.generate_conversation_summary')
...
class TestDialogueMemoryEdgeCases:
    ...
    @patch('src.silas.memory.conversation.update_daily_conversation_summary')
