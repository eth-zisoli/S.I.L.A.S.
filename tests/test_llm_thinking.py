...
from silas.config import get_default_config
...
class TestLlmThinkingPayload:
    ...
    @patch("silas.llm.requests.post")
    def test_call_llm_direct_thinking_false(self, mock_post):
        from silas.llm import call_llm_direct
    ...
    def test_call_llm_streaming_thinking(self, mock_post):
        from silas.llm import call_llm_streaming
    ...
    def test_chat_with_messages_thinking(self, mock_post):
        from silas.llm import chat_with_messages
...
class TestIntentJudgeThinking:
    ...
    def test_config_default_thinking_false(self):
        from silas.listening.intent_judge import IntentJudgeConfig
    ...
    def test_create_intent_judge_passes_thinking(self):
        ...
        from silas.listening.intent_judge import create_intent_judge
...
class TestDictationThinking:
    ...
    def test_llm_clean_dictation_sends_think_false(self):
        from src.silas.dictation.dictation_engine import _llm_clean_dictation
...
class TestCallLlmDirectFailurePaths:
    ...
    def test_timeout_returns_none(self):
        ...
        with patch('silas.llm.requests.post', side_effect=requests.exceptions.Timeout):
    ...
    def test_request_exception_returns_none(self):
        ...
        with patch('silas.llm.requests.post', side_effect=ConnectionError("boom")):
            result = call_llm_direct(
                base_url="http://localhost:99999",
                chat_model="test-model",
                system_prompt="sys",
