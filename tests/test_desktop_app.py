...
class TestGetCrashPaths:
    ...
    def test_paths_have_expected_names(self):
        ...
        crash_log, crash_marker, previous_crash = get_crash_paths()
        assert crash_log.name == "silas_desktop_crash.log"
    ...
    def test_macos_uses_library_logs(self):
        """On macOS, should use ~/Library/Logs/Silas."""
...
class TestCheckModelSupport:
    ...
    @patch("silas.config.load_config")
...
class TestModelSupportIntegration:
    ...
    def test_all_supported_models_pass_check(self):
        ...
        for model_id in SUPPORTED_CHAT_MODELS:
            with patch("silas.config.load_config") as mock_config:
...
class TestLogViewerReportIssue:
    ...
    def test_report_issue_url_generation(self):
        ...
        from silas.utils.redact import redact
...
"""
        ...
        # Parse and verify
        assert url.startswith("https://github.com/isair/silas/issues/new?")
    ...
    def test_report_issue_truncates_long_logs(self):
        ...
        assert "Silas Log Viewer Ready" in result
    ...
    def test_faulthandler_dump_preserves_fatal_error_line(self):
        ...
        init_block = (
            "=== Silas Desktop App Crash Log ===\n"
            "Timestamp: 2026-04-13\n"
            "Platform: win32\n"
            "==================================================\n"
            "\nStarting Silas Desktop App...\n"
            "Creating QApplication...\n"
            "🚀 Silas daemon started\n"
            f"{_LOG_SEPARATOR}\n"
        )
        ...
        # Init section should be preserved
        assert "Silas Desktop App Crash Log" in result
...
class TestSingleInstanceLock:
    ...
    def test_get_existing_instance_pid_reads_pid(self, tmp_path):
        ...
        lock_file = tmp_path / "silas_desktop.lock"
...
class TestCudaRecoveryAction:
    ...
    def test_quote_arg_handles_trailing_backslash(self):
        ...
        `C:\\Program Files\\Silas\\` quoted naively becomes
        `"C:\\Program Files\\Silas\\"` which CommandLineToArgvW reads as
        `C:\\Program Files\\Silas"` — quote eaten, next arg fused on. The
        ...
        result = _quote_arg(r"C:\Program Files\Silas\\")
