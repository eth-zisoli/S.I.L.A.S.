...
import pytest
from silas.tools.registry import discover_mcp_tools, generate_tools_description, generate_tools_json_schema, run_tool_with_retries, ToolExecutionResult
...
def test_discover_mcp_tools_with_fake_server(monkeypatch):
    ...
    import silas.tools.registry as registry_mod
...
def test_generate_tools_description_includes_mcp_tools():
    ...
    from silas.tools.registry import ToolSpec
