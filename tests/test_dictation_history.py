...
class TestDictationHistory:
    ...
    def _make_history(self, tmp_path):
        from src.silas.dictation.history import DictationHistory
...
class TestMenuIntegration:
    ...
    def test_create_menu_has_dictation_action(self):
        ...
        import inspect
        from src.desktop_app.app import SilasSystemTray
        source = inspect.getsource(SilasSystemTray.create_menu)
    ...
    def test_show_dictation_history_method_exists(self):
        from src.desktop_app.app import SilasSystemTray
        assert hasattr(SilasSystemTray, "show_dictation_history")
        assert callable(getattr(SilasSystemTray, "show_dictation_history"))
