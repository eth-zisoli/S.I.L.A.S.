...
def test_auto_detect_falls_back_to_opendns_when_upnp_and_socket_fail():
    ...
    with patch("silas.utils.location._get_external_ip_via_upnp", return_value=None), \
         patch("silas.utils.location._get_external_ip_via_socket", return_value=None), \
         patch("silas.utils.location._resolve_public_ip_via_opendns", return_value="93.184.216.34") as mock_dns:
...
def test_auto_detect_skips_opendns_when_upnp_succeeds():
    ...
    with patch("silas.utils.location._get_external_ip_via_upnp", return_value="203.0.113.1"), \
         patch("silas.utils.location._resolve_public_ip_via_opendns") as mock_dns:
        result = _get_external_ip_automatically()
...
def test_auto_detect_skips_opendns_when_socket_succeeds():
    ...
    with patch("silas.utils.location._get_external_ip_via_upnp", return_value=None), \
         patch("silas.utils.location._get_external_ip_via_socket", return_value="198.51.100.5"), \
         patch("silas.utils.location._resolve_public_ip_via_opendns") as mock_dns:
        result = _get_external_ip_automatically()
        mock_dns.assert_not_called()
...
def test_auto_detect_returns_none_when_all_methods_fail():
    ...
    with patch("silas.utils.location._get_external_ip_via_upnp", return_value=None), \
         patch("silas.utils.location._get_external_ip_via_socket", return_value=None), \
         patch("silas.utils.location._resolve_public_ip_via_opendns", return_value=None):
        result = _get_external_ip_automatically()
...
def test_auto_detect_rejects_private_ip_from_opendns():
    ...
    with patch("silas.utils.location._get_external_ip_via_upnp", return_value=None), \
         patch("silas.utils.location._get_external_ip_via_socket", return_value=None), \
         patch("silas.utils.location._resolve_public_ip_via_opendns", return_value="192.168.1.1"):
        result = _get_external_ip_automatically()
        assert result is None
