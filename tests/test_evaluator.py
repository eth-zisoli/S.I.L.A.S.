...
from silas.reply.evaluator import evaluate_turn, EvaluatorResult, _parse_result
...
class TestEvaluateTurn:
    ...
    def test_terminal_path(self):
        with patch(
            "silas.reply.evaluator.call_llm_direct",
...
class TestEvaluatorGarbledTurnGuidance:
    ...
    def test_prompt_mentions_garbled_marker_recognition(self):
        from silas.reply.evaluator import _EVALUATOR_SYSTEM_PROMPT
