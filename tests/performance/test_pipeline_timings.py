...
OLLAMA_URL = os.environ.get("SILAS_PERF_OLLAMA_URL", "http://localhost:11434")
PERF_MODEL = os.environ.get("SILAS_PERF_MODEL", "gemma4:e2b")
PERF_RUNS = int(os.environ.get("SILAS_PERF_RUNS", "3"))
PERF_REPORT_DIR = Path(os.environ.get(
    "SILAS_PERF_REPORT_DIR",
...
def test_micro_benchmark_tiny_prompt():
    ...
    # silas.llm is visible at call time.
    from silas import llm as _llm
