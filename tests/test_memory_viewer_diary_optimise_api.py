...
class TestDiaryOptimiseTopicsEndpoint:
    ...
    def setup_app(self, tmp_path):
        ...
        for date_utc, summary, topics in [
            ...
            seed_db.upsert_conversation_summary(
                date_utc=date_utc, summary=summary, topics=topics, source_app="silas",
            )
    ...
    def _stream(self, fake_events=None) -> list[dict]:
        ...
        with (
            ...
            patch("src.silas.memory.conversation.optimise_diary_topics", _make_fake_optimise(fake_events)),
            patch("silas.memory.conversation.optimise_diary_topics", _make_fake_optimise(fake_events)),
        ):
