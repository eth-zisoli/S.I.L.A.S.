...
from src.silas.tools.builtin.screenshot import ScreenshotTool
...
class TestScreenshotTool:
    ...
    def test_run_success(self, mock_run, mock_which):
        ...
        with patch('tempfile.mkdtemp', return_value='/tmp/silas_ocr_test'), \
    ...
    def test_run_empty_ocr(self, mock_run, mock_which):
        ...
        with patch('tempfile.mkdtemp') as mock_tmp, \
            ...
            mock_tmp.return_value = '/tmp/silas_ocr_test'
