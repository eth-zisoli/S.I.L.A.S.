...
from src.silas.tools.builtin.nutrition.log_meal import LogMealTool
from src.silas.tools.base import ToolContext
from src.silas.tools.types import ToolExecutionResult
from src.silas.reply.planner import _parse_plan_step_concrete
...
class TestLogMealTool:
    ...
    @patch('src.silas.tools.builtin.nutrition.log_meal.extract_and_log_meal')
    ...
    def test_run_returns_friendly_failure_when_both_meal_and_redacted_empty(self):
        ...
        with patch(
            'src.silas.tools.builtin.nutrition.log_meal.extract_and_log_meal'
        ) as mock_extract:
...
def test_extractor_wraps_user_text_in_untrusted_fence():
    ...
    from src.silas.tools.builtin.nutrition.log_meal import extract_and_log_meal
    ...
    with patch(
        'src.silas.tools.builtin.nutrition.log_meal.call_llm_direct',
