...
from src.silas.tools.builtin.web_search import WebSearchTool
from src.silas.tools.base import ToolContext
...
class TestWebSearchTool:
    ...
    @patch('src.silas.tools.builtin.web_search._fetch_page_content')
    @patch('requests.get')
    ...
    def test_is_public_url_rejects_private_and_non_http(self):
        ...
        from src.silas.tools.builtin.web_search import _is_public_url
        # Scheme filter
    ...
    @patch('src.silas.tools.builtin.web_search._fetch_page_content')
    @patch('src.silas.tools.builtin.web_search._brave_search')
    @patch('requests.get')
    ...
    @patch('src.silas.tools.builtin.web_search._wikipedia_summary')
    @patch('requests.get')
...
class TestBraveSearchHelper:
    ...
    @patch("src.silas.tools.builtin.web_search.requests.get")
    def test_returns_empty_without_key(self, mock_get):
        from src.silas.tools.builtin.web_search import _brave_search
    ...
    @patch("src.silas.tools.builtin.web_search.debug_log")
    @patch("src.silas.tools.builtin.web_search.requests.get")
...
class TestWikipediaSummaryHelper:
    ...
    def test_returns_title_url_extract(self, mock_get):
        from src.silas.tools.builtin.web_search import _wikipedia_summary
    ...
    def test_deadline_shrinks_request_timeout(self, mock_get):
        ...
        import time as _time
        from src.silas.tools.builtin.web_search import (
...
class TestWikipediaLanguageScriptMismatch:
    ...
    def test_mismatch_overrides_lang_to_english(self, mock_get, mock_wiki):
        ...
        from src.silas.tools.registry import run_tool_with_retries
        cfg = Mock()
...
class TestLanguagePlumbingEndToEnd:
    ...
    def test_listener_stores_detected_language_attribute(self):
        ...
        from src.silas.listening import listener as listener_module
        import inspect
