...
from silas.listening.intent_judge import (
    IntentJudge,
    IntentJudgeConfig,
    IntentJudgment,
    create_intent_judge,
...
class TestIntentJudgeConfig:
    ...
    def test_default_config(self):
        ...
        assert config.assistant_name == "Silas"
...
class TestIntentJudge:
    ...
    def test_init(self):
        ...
        judge = IntentJudge()
        assert judge.config.assistant_name == "Silas"
    ...
    def test_build_user_prompt_basic(self):
        ...
        judge = IntentJudge()
        segments = [
            TranscriptSegment("hello silas", 1000.0, 1001.0),
        ]
    ...
    def test_judge_with_mock_api(self):
        ...
        segments = [
            TranscriptSegment("silas what time is it", 1000.0, 1002.0),
        ]

        with patch('silas.listening.intent_judge.requests.post', return_value=mock_response):
            result = judge.judge(
                segments,
                wake_timestamp=1000.5,
                last_tts_text="",
    ...
    def test_judge_handles_timeout(self):
        ...
        with patch('silas.listening.intent_judge.requests.post', side_effect=real_requests.Timeout()):
            result = judge.judge(segments)
    ...
    def test_connection_error_does_trigger_backoff(self):
        ...
        with patch(
            'silas.listening.intent_judge.requests.post',
...
class TestWarmUp:
    ...
    def test_warmup_posts_to_generate_with_keep_alive(self):
        ...
        with patch("silas.listening.intent_judge.requests") as mock_requests:
...
class TestCurrentSegmentMarker:
    ...
    def test_current_segment_marked_in_prompt(self):
        ...
        segments = [
            ...
            TranscriptSegment("hello silas", 1002.0, 1003.0),  # New segment
        ]
        prompt = judge._build_user_prompt(
            segments,
            wake_timestamp=None,
            ...
            last_tts_finish_time=0.0,
            in_hot_window=True,
            current_text="hello silas",  # Mark this as current
        )
    ...
    def test_current_segment_case_insensitive_match(self):
        ...
        prompt = judge._build_user_prompt(
            ...
            last_tts_finish_time=0.0,
            in_hot_window=True,
            current_text="hello silas",  # Different case
        )
    ...
    def test_judge_passes_current_text_to_prompt(self):
        ...
        with patch('silas.listening.intent_judge.requests.post', return_value=mock_response) as mock_post:
            judge.judge(
                segments,
                wake_timestamp=None,
...
class TestCrossSegmentContextInPrompt:
    ...
    def test_context_segments_included_in_user_prompt(self):
        ...
        segments = [
            ...
            TranscriptSegment("What do you think about that Silas", 1002.0, 1003.0),
        ]
        prompt = judge._build_user_prompt(
            segments,
...
class TestProcessedSegmentFiltering:
    ...
    def test_processed_segments_filtered_from_prompt(self):
        ...
        judge = IntentJudge()
        segments = [
            TranscriptSegment("silas whats the weather", 1000.0, 1001.0, processed=True),
            TranscriptSegment("silas tell me a joke", 1002.0, 1003.0),
        ]
        prompt = judge._build_user_prompt(
            segments,
            wake_timestamp=None,
            ...
            last_tts_finish_time=0.0,
            in_hot_window=True,
            current_text="silas tell me a joke",
        )
    ...
    def test_current_segment_shown_even_if_processed(self):
        ...
        segments = [
            TranscriptSegment("silas tell me a joke", 1000.0, 1001.0, processed=True),
        ]
        prompt = judge._build_user_prompt(
            segments,
            wake_timestamp=None,
            ...
            last_tts_finish_time=0.0,
            in_hot_window=True,
            current_text="silas tell me a joke",  # Same as processed segment
        )
    ...
    def test_unprocessed_context_segments_preserved(self):
        ...
        segments = [
            ...
            TranscriptSegment("silas old query", 1001.0, 1002.0, processed=True),  # Processed
            TranscriptSegment("Yeah me too", 1002.0, 1003.0),  # Context
            TranscriptSegment("silas what do you think", 1003.0, 1004.0),  # Current
        ]
        prompt = judge._build_user_prompt(
            segments,
            wake_timestamp=None,
            ...
            last_tts_finish_time=0.0,
            in_hot_window=True,
            current_text="silas what do you think",
        )
