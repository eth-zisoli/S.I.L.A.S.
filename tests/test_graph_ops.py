...
from src.silas.memory.graph import GraphMemoryStore, SPLIT_THRESHOLD
from src.silas.memory.graph import BRANCH_USER, BRANCH_DIRECTIVES, BRANCH_WORLD
from src.silas.memory.graph_ops import (
...
class TestFindBestNode:
    ...
    @patch("src.silas.memory.graph_ops._llm_pick_best_child")
...
class TestMergeSystemPromptInvariants:
    ...
    def test_prompt_lists_supersession_rule(self):
        from src.silas.memory.graph_ops import _MERGE_SYSTEM_PROMPT
