...
from src.silas.tools.registry import discover_mcp_tools, generate_tools_description
...
def test_mcp_discovery_with_mock():
    ...
    try:
        with patch('src.silas.tools.registry.MCPClient', FakeMCPClient):
...
def test_tool_registration_in_descriptions():
    ...
    from src.silas.tools.registry import ToolSpec
...
def test_error_handling():
    ...
    try:
        with patch('src.silas.tools.registry.MCPClient', FaultyMCPClient):
            mcps_config = {
