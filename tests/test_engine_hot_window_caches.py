...
from src.silas.memory.conversation import DialogueMemory
from src.silas.reply.engine import run_reply_engine
...
@pytest.mark.unit
@patch("src.silas.memory.graph_ops.format_warm_profile_block", return_value="")
@patch("src.silas.memory.graph_ops.build_warm_profile", return_value={"user": "", "directives": ""})
@patch("src.silas.memory.graph.GraphMemoryStore")
@patch("src.silas.reply.engine.select_tools", return_value=[])
@patch("src.silas.reply.engine.plan_query", return_value=[])
@patch("src.silas.reply.engine.extract_search_params_for_memory", return_value={})
@patch("src.silas.reply.engine.extract_text_from_response")
@patch("src.silas.reply.engine.chat_with_messages")
...
def test_router_fallback_to_all_tools_is_not_cached(
    ...
    """
    from src.silas.tools.registry import BUILTIN_TOOLS
    ...
    with patch(
        "src.silas.reply.engine.select_tools",
...
@patch("src.silas.reply.engine.select_tools", return_value=[])
@patch("src.silas.reply.engine.plan_query", return_value=[])
@patch("src.silas.reply.engine.extract_search_params_for_memory", return_value={"keywords": ["x"], "questions": []})
@patch("src.silas.memory.conversation.search_conversation_memory_by_keywords", return_value=[])
@patch("src.silas.reply.engine.extract_text_from_response")
@patch("src.silas.reply.engine.chat_with_messages")
...
@pytest.mark.unit
@patch("src.silas.memory.graph_ops.format_warm_profile_block", return_value="warm-block")
@patch("src.silas.memory.graph_ops.build_warm_profile", return_value={"user": "u", "directives": "d"})
@patch("src.silas.memory.graph.GraphMemoryStore")
@patch("src.silas.reply.engine.select_tools", return_value=[])
@patch("src.silas.reply.engine.plan_query", return_value=[])
@patch("src.silas.reply.engine.extract_search_params_for_memory", return_value={})
...
@patch("src.silas.reply.engine.select_tools", return_value=[])
@patch(
    "src.silas.reply.engine.plan_query",
    return_value=["searchMemory topic='justin bieber'", "reply"],
)
@patch("src.silas.reply.engine.extract_search_params_for_memory",
