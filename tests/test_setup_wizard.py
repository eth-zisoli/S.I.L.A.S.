...
from silas.config import DEFAULT_CHAT_MODEL
...
class TestLocationDetectionForWizard:
    ...
    def test_location_context_returns_unknown_when_unavailable(self):
        ...
        with patch("silas.utils.location._get_external_ip_automatically", return_value=None):
            with patch("silas.utils.location._get_local_network_ip", return_value="192.168.1.1"):
    ...
    def test_location_availability_check(self):
        ...
        with patch("silas.utils.location.GEOIP2_AVAILABLE", False):
        ...
        with patch("silas.utils.location._get_database_path") as mock_path:
    ...
    def test_location_context_with_config_ip(self):
        ...
        with patch("silas.utils.location.get_location_info", return_value=mock_location):
...
class TestModelOptions:
    ...
    def test_model_options_uses_centralized_config(self):
        ...
        from desktop_app.setup_wizard import ModelsPage
        from silas.config import SUPPORTED_CHAT_MODELS
...
class TestMCPPage:
    ...
    def test_is_already_configured_returns_false_on_empty_config(self):
        ...
        with patch("silas.config._load_json", return_value={}):
    ...
    def test_is_already_configured_returns_true_when_present(self):
        ...
        with patch("silas.config._load_json", return_value=mock_config):
    ...
    def test_is_already_configured_handles_exception(self):
        ...
        with patch("silas.config._load_json", side_effect=Exception("boom")):
            assert MCPPage._is_already_configured("filesystem") is False
    ...
    def test_validate_page_saves_selected_mcps(self):
        ...
        from silas.config import _load_json
        ...
        try:
            ...
            with patch("silas.config.default_config_path", return_value=cfg_path):
    ...
    def test_is_node_available_returns_true_when_npx_found(self):
        ...
        with patch("silas.tools.external.mcp_client._resolve_command", return_value="/usr/bin/npx"):
    ...
    def test_is_node_available_returns_false_when_npx_missing(self):
        ...
        with patch("silas.tools.external.mcp_client._resolve_command", side_effect=FileNotFoundError("not found")):
