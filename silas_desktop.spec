...
"""
PyInstaller spec file for Silas Desktop App
...
hiddenimports = [
    ...
    # Listening modules
    'silas.listening',
    'silas.listening.echo_detection',
    'silas.listening.listener',
    'silas.listening.state_manager',
    'silas.listening.wake_detection',
    'silas.listening.transcript_buffer',
    'silas.listening.intent_judge',
    # Memory modules
    'silas.memory',
    'silas.memory.conversation',
    'silas.memory.db',
    'silas.memory.embeddings',
    # Output modules
    'silas.output',
    'silas.output.tts',
    'silas.output.tune_player',
    ...
    # Profile modules
    'silas.profile',
    'silas.profile.profiles',
    # Reply modules
    'silas.reply',
    'silas.reply.engine',
    'silas.reply.enrichment',
    # Tools modules
    'silas.tools',
    'silas.tools.base',
    'silas.tools.registry',
    'silas.tools.types',
    'silas.tools.builtin',
    'silas.tools.builtin.fetch_web_page',
    'silas.tools.builtin.local_files',
    'silas.tools.builtin.nutrition',
    'silas.tools.builtin.nutrition.delete_meal',
    'silas.tools.builtin.nutrition.fetch_meals',
    'silas.tools.builtin.nutrition.log_meal',
    'silas.tools.builtin.recall_conversation',
    'silas.tools.builtin.refresh_mcp_tools',
    'silas.tools.builtin.screenshot',
    'silas.tools.builtin.web_search',
    'silas.tools.external',
    'silas.tools.external.mcp_client',
    # Utils modules
    'silas.utils',
    'silas.utils.fast_vector_store',
    'silas.utils.fuzzy_search',
    'silas.utils.location',
    'silas.utils.redact',
    'silas.utils.vector_store',
    # PyQt6
    'PyQt6.QtCore',
    'PyQt6.QtGui',
    'PyQt6.QtWidgets',
...
if sys.platform == 'darwin':
    ...
    app = BUNDLE(
        ...
        name='Silas.app',
        icon=str(src_path / 'desktop_app' / 'desktop_assets' / 'icon_idle.png'),
        bundle_identifier='com.silas.assistant',
        info_plist={
            'NSHighResolutionCapable': 'True',
            'LSUIElement': '1',  # Hide from dock
            'NSMicrophoneUsageDescription': 'Silas needs microphone access to listen for voice commands.',
            'NSScreenCaptureUsageDescription': 'Silas needs screen capture access to read text from your screen via OCR.',
        },
    )

    # Post-build: Ensure OpenSSL libraries are correct and remove conflicting ones
    import shutil
    frameworks_dir = Path('dist/Silas.app/Contents/Frameworks')
    ...
    resources_dir = Path('dist/Silas.app/Contents/Resources')
