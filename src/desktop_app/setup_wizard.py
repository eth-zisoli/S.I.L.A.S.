...
from silas.config import SUPPORTED_CHAT_MODELS, DEFAULT_CHAT_MODEL
...
from silas.config import load_settings, get_default_config, default_config_path
...
try:
    ...
    from desktop_app.themes import SILAS_THEME_STYLESHEET, COLORS, _ensure_icons, _ICON_STYLESHEET_TEMPLATE
...
class SetupWizard(QWizard):
    ...
    def __init__(self, parent=None):
        super().__init__(parent)
        self.setWindowTitle("🚀 Silas Setup Wizard")
        ...
        self.setButtonText(QWizard.WizardButton.FinishButton, "🎉 Start Silas")
    ...
    def _apply_theme(self):
        """Apply the shared Silas theme with SVG indicator icons."""
        icons = _ensure_icons()
        icon_css = _ICON_STYLESHEET_TEMPLATE.format(**icons)
        self.setStyleSheet(SILAS_THEME_STYLESHEET + icon_css + """
...
class OllamaInstallPage(QWizardPage):
    ...
    def __init__(self, parent=None):
        ...
        subtitle = QLabel("Ollama is required to run local AI models for Silas.")
        subtitle.setObjectName("subtitle")
...
class OllamaServerPage(QWizardPage):
    ...
    def __init__(self, parent=None):
        ...
        subtitle = QLabel("The Ollama server needs to be running for Silas to use AI models.")
        subtitle.setObjectName("subtitle")
        subtitle.setWordWrap(True)
        layout.addWidget(subtitle)
    ...
    def _start_server(self):
        ...
        try:
            ...
            # running after Silas exits. Ollama is a system service that should
...
class ModelsPage(QWizardPage):
    ...
    def __init__(self, parent=None):
        ...
        subtitle = QLabel("Silas needs specific AI models to work. Choose your model and install.")
        subtitle.setObjectName("subtitle")
        subtitle.setWordWrap(True)
        layout.addWidget(subtitle)
    ...
    def _skip_models(self):
        ...
        self._is_complete = True
        self.status_label.setText("⚠️ Skipped model installation. Silas may not work correctly without all models.")
        self.status_label.setStyleSheet("color: #fbbf24;")
        self.completeChanged.emit()
...
class LocationPage(QWizardPage):
    ...
    def __init__(self, parent=None):
        ...
        subtitle = QLabel("Location helps Silas provide weather, local services, and time-aware responses.")
        subtitle.setObjectName("subtitle")
        subtitle.setWordWrap(True)
        layout.addWidget(subtitle)
    ...
    def _open_ip_lookup(self):
        ...
        from silas.utils.location import _resolve_public_ip_via_opendns
...
class DictationPage(QWizardPage):
    ...
    @staticmethod
    def _hotkey_options():
        from silas.dictation.dictation_engine import format_hotkey_display
        from silas.config import _default_dictation_hotkey
    ...
    def _load_current_filler_removal(self) -> bool:
        ...
        try:
            from silas.config import default_config_path, _load_json
    ...
    def _load_current_hotkey(self) -> str:
        ...
        try:
            from silas.config import default_config_path, _load_json, _default_dictation_hotkey
            config = _load_json(default_config_path())
    ...
    def validatePage(self) -> bool:
        ...
        try:
            from silas.config import default_config_path, _load_json, _save_json
            config_path = default_config_path()
...
class MCPPage(QWizardPage):
    ...
    def __init__(self, parent=None):
        ...
        subtitle = QLabel(
            "MCP (Model Context Protocol) servers give Silas extra abilities. "
        ...
        self._node_warning = QLabel(
            ...
            "and restart Silas, or skip this page for now."
        )
    ...
    def _is_node_available() -> bool:
        ...
        try:
            from silas.tools.external.mcp_client import _resolve_command
...
class SearchProvidersPage(QWizardPage):
    ...
    should understand what Silas will and won't reach over the network
    ...
    def __init__(self, parent=None):
        ...
        subtitle = QLabel(
            "Silas uses DuckDuckGo for web search. When DuckDuckGo blocks a "
        ...
        tip = QLabel(
            "💡  When every provider fails, Silas tells you the search was "
...
class CompletePage(QWizardPage):
    ...
    def __init__(self, parent=None):
        ...
        subtitle = QLabel("Silas is ready to use. Click 'Start Silas' to launch the voice assistant.")
        subtitle.setObjectName("subtitle")
        subtitle.setWordWrap(True)
        subtitle.setAlignment(Qt.AlignmentFlag.AlignCenter)
        layout.addWidget(subtitle)
        ...
        tips = QLabel(
            "• Say your wake word (e.g. 'Silas') anywhere in your sentence to activate the assistant\n"
            "• After Silas replies, speak your follow-up — no need to repeat the wake word\n"
            "• Silas will appear in your system tray (menu bar on macOS)\n"
        ...
        brain_tip = QLabel("🧠  Peek inside Silas's brain — open the Memory Viewer to see what he remembers")
