...
from desktop_app.themes import SILAS_THEME_STYLESHEET, COLORS
...
class DictationHistoryWindow(QMainWindow):
    ...
    def _is_dictation_enabled(self) -> bool:
        ...
        try:
            from silas.config import default_config_path, _load_json, get_default_config
    ...
    def _get_history_file_mtime(self) -> float:
        ...
        try:
            from silas.dictation.history import _default_history_path
