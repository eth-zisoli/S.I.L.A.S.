...
def _ensure_icons() -> dict[str, str]:
    ...
    if _icon_dir is None:
        _icon_dir = tempfile.mkdtemp(prefix="silas_theme_")
...
def apply_theme(widget) -> None:
    """Apply the Silas theme to a Qt widget, including SVG-based indicator icons."""
    icons = _ensure_icons()
    icon_css = _ICON_STYLESHEET_TEMPLATE.format(**icons)
    widget.setStyleSheet(SILAS_THEME_STYLESHEET + icon_css)
