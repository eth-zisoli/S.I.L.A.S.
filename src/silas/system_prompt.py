...
name rather than a persona hardcoded to "Silas".
"""
...
def build_system_prompt(assistant_name: str = "Silas") -> str:
    ...
    "Silas" when no config is available (tests, eval harnesses).
    """
    name = (assistant_name or "Silas").strip() or "Silas"
