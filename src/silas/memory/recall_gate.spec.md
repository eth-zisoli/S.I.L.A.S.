...
- File: `src/silas/memory/recall_gate.py`.
- Caller: `run_reply_engine` in `src/silas/reply/engine.py`, between the planner's `needs_memory` decision and the diary/graph search.
